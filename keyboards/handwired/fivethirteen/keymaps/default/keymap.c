...
[ZER] = KEYMAP(
  ...
  MO(HDN), KC_LCTL, KC_LALT, KC_LGUI, MO(HDN),    KC_SPC    ,    SFT_BSP, MO(HDN), MO(OSY), KC_LEFT, KC_DOWN, KC_RGHT  \
),
[HDN] = KEYMAP(
  ...
  _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_PWR,  _______, _______, KC_ENT,  _______, _______, _______, KC_PGUP, _______, \
