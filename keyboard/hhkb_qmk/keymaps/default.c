...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [HIDDEN] = KEYMAP_JP(
    ...
    ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, S(KC_BSLS), ______, ______,
    ______, KC_VOLD, KC_VOLU, KC_MUTE, ______, ______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, ______, ______, ______, ______,
    ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,
    ______, ______, ______, ______, ______,   S(KC_MINS)  , ______, ______, ______, ______, ______, ______, ______
  ),
